...
const dataItems: FocusItem[] = [
  ...
  },
  {
    ...
    details: ["รหัสหลัก", "รหัสหน่วยงาน", "ชื่อหน่วยงาน", "รหัสสำนัก/กอง"],
  },
  {
    id: "division",
    kind: "data",
    ...
    details: ["รหัสหลักสำนัก/กอง", "รหัสสำนัก/กอง", "ชื่อสำนัก/กอง"],
  },
  {
    id: "asset-group",
    kind: "data",
...
const principleItems: FocusItem[] = [
  {
    ...
    details: [
      "ผู้ใช้เลือกประเภทข้อมูล",
      "เลือกได้ 1 รายการหรือหลายรายการ",
      "ลดการส่งข้อมูลเกินจำเป็น",
    ],
  },
  {
    id: "reference-code",
    ...
    color: "from-blue-700 to-sky-500",
    details: [
      "ทุกประเภทต้องมีรหัสอ้างอิง",
      "ใช้ตรวจซ้ำและอัปเดตข้อมูลเดิม",
      "เช่น asset_code, organization_code",
    ],
  },
  {
    id: "upsert",
    ...
    details: [
      ...
      "ต้องตกลงพฤติกรรมซ้ำกับ API ภายนอก",
    ],
  },
  {
    id: "validate",
    ...
    details: [
      "เช็กฟิลด์บังคับ",
      "เช็กชนิดข้อมูลและรูปแบบ",
      "แจ้งผู้ใช้ก่อนเรียก API จริง",
    ],
  },
];
...
const stepItems: FocusItem[] = [
  {
    ...
    kind: "step",
    title: "เลือกประเภท",
    subtitle: "เริ่มจากชนิดข้อมูล",
    icon: Route,
    color: "from-blue-700 to-sky-500",
    details: ["เลือกครุภัณฑ์ หน่วยงาน สำนัก/กอง หรือ master data อื่น"],
  },
  {
    id: "filter-list",
    kind: "step",
    title: "กรองรายการ",
    subtitle: "เฉพาะที่ควรส่ง",
    icon: SearchCheck,
    color: "from-blue-700 to-sky-500",
    details: ["ยังไม่เคยส่ง", "ส่งไม่สำเร็จ", "มีการแก้ไขหลังส่งล่าสุด"],
  },
  {
    id: "pick-records",
    kind: "step",
    title: "เลือกรายการ",
    subtitle: "เดี่ยวหรือหลายรายการ",
    icon: ListChecks,
    color: "from-blue-700 to-sky-500",
    details: ["เลือกส่ง 1 รายการ", "เลือกหลายรายการเพื่อส่งเป็นชุด"],
  },
  {
    id: "validate-data",
    kind: "step",
    title: "Validate",
    subtitle: "เช็กความครบถ้วน",
    icon: ShieldCheck,
    color: "from-blue-700 to-sky-500",
    details: ["ตรวจข้อมูลบังคับ", "หยุดส่งถ้าข้อมูลไม่ครบ"],
  },
  {
    id: "write-log",
    kind: "step",
    title: "บันทึก Log",
    subtitle: "สร้างร่องรอยก่อนส่ง",
    icon: History,
    color: "from-blue-700 to-sky-500",
    details: ["บันทึก payload", "บันทึกผู้ส่งและเวลา", "นับจำนวนครั้งที่ส่ง"],
  },
  {
    id: "send-api",
    kind: "step",
    title: "ส่ง API",
    subtitle: "เรียกปลายทาง",
    icon: Send,
    color: "from-blue-700 to-sky-500",
    details: ["ส่ง JSON ตามรูปแบบที่ตกลง", "รองรับการส่งเป็น batch ตาม limit"],
  },
  {
    id: "wait-response",
    kind: "step",
    title: "รับผล",
    subtitle: "success หรือ error",
    icon: Code2,
    color: "from-blue-700 to-sky-500",
    details: ["อ่าน response จาก API", "แยกผลสำเร็จและไม่สำเร็จรายรายการ"],
  },
  {
    id: "update-status",
    kind: "step",
    title: "อัปเดตสถานะ",
    subtitle: "จบวงจรการส่ง",
    icon: BadgeCheck,
    color: "from-blue-700 to-sky-500",
    details: ["ส่งสำเร็จ", "ส่งไม่สำเร็จ", "มีการแก้ไขหลังส่งล่าสุด"],
  },
];
...
const statusItems: FocusItem[] = [
  {
    ...
    kind: "status",
    title: "ยังไม่ส่ง",
    subtitle: "ยังไม่เคยออก API",
    icon: Clock3,
    color: "from-slate-600 to-slate-400",
    details: ["มีข้อมูลใน Asset", "ยังไม่มีประวัติส่งไป API"],
  },
  {
    id: "queued",
    kind: "status",
    title: "รอส่ง",
    subtitle: "เลือกไว้หรือเข้าคิว",
    icon: Clock3,
    color: "from-amber-600 to-yellow-400",
    details: ["ผู้ใช้เลือกไว้แล้ว", "หรือระบบจัดเข้าคิวรอส่ง"],
  },
  {
    id: "success",
    kind: "status",
    title: "ส่งสำเร็จ",
    subtitle: "API รับแล้ว",
    icon: CheckCircle2,
    color: "from-emerald-700 to-green-500",
    details: ["API ตอบกลับว่าสำเร็จ", "บันทึกวันที่ส่งล่าสุดและ response"],
  },
  {
    id: "failed",
    kind: "status",
    title: "ส่งไม่สำเร็จ",
    subtitle: "ส่งแล้วมีปัญหา",
    icon: XCircle,
    color: "from-rose-700 to-red-500",
    details: [
      "API ตอบผิดพลาด",
      "หรือเชื่อมต่อไม่ได้",
      "ต้องแสดงสาเหตุให้ชัดเจน",
    ],
  },
  {
    id: "changed",
    kind: "status",
    title: "แก้ไขหลังส่ง",
    subtitle: "ต้องส่ง update",
    icon: Pencil,
    color: "from-violet-700 to-purple-500",
    details: [
      "เคยส่งสำเร็จแล้ว",
      "ข้อมูลใน Asset ถูกแก้ไขใหม่",
      "ควรเตือนให้ส่งอัปเดตอีกครั้ง",
    ],
  },
  {
    id: "retry",
    kind: "status",
    title: "ส่งซ้ำ",
    subtitle: "เฉพาะรายการมีปัญหา",
    icon: RefreshCcw,
    color: "from-cyan-700 to-teal-500",
    details: [
      "ใช้กับรายการส่งไม่สำเร็จ",
      "หรือรายการที่แก้ไขหลังส่งล่าสุด",
      "ไม่ต้องส่งทุกอย่างใหม่",
    ],
  },
];
...
const apiItems: FocusItem[] = [
  {
    ...
    kind: "api",
    title: "Endpoint",
    subtitle: "URL รับข้อมูล",
    icon: Globe2,
    color: "from-blue-700 to-sky-500",
    details: ["แยกตามประเภทข้อมูล", "หรือ endpoint กลางที่มี data_type"],
  },
  {
    id: "format",
    kind: "api",
    title: "JSON Format",
    subtitle: "โครงสร้าง payload",
    icon: FileJson,
    color: "from-emerald-700 to-green-500",
    details: ["field name", "ชนิดข้อมูล", "ความยาว", "ฟิลด์บังคับ"],
  },
  {
    id: "auth",
    kind: "api",
    title: "Auth",
    subtitle: "สิทธิ์เรียก API",
    icon: KeyRound,
    color: "from-amber-600 to-yellow-400",
    details: ["Token", "API Key", "Bearer Token"],
  },
  {
    id: "response-format",
    kind: "api",
    title: "Response",
    subtitle: "รูปแบบผลลัพธ์",
    icon: Code2,
    color: "from-violet-700 to-purple-500",
    details: ["success true/false", "message", "external_id", "errors"],
  },
  {
    id: "duplicate",
    kind: "api",
    title: "Duplicate",
    subtitle: "ส่งรหัสเดิมซ้ำ",
    icon: RefreshCcw,
    color: "from-cyan-700 to-teal-500",
    details: ["อัปเดตข้อมูลเดิม", "หรือแจ้งว่าซ้ำ", "ต้องกำหนดให้ชัด"],
  },
  {
    id: "payload-limit",
    kind: "api",
    title: "Payload Limit",
    subtitle: "ขนาดต่อครั้ง",
    icon: Database,
    color: "from-rose-700 to-red-500",
    details: ["จำกัด batch size", "ระวังรูปภาพประกอบรถ"],
  },
];
...
const retryItem: FocusItem = {
  ...
  details: [
    "เลือกเฉพาะรายการส่งไม่สำเร็จ",
    "ถ้า API ไม่ตอบ ให้บันทึกส่งไม่สำเร็จ",
    "ถ้าข้อมูลผิด ให้แสดง error",
    "มีหน้าค้นหาประวัติย้อนหลัง",
  ],
};
...
function IconButton({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto flex ${compact ? "h-11 w-11" : "h-14 w-14"} items-center justify-center rounded-full bg-gradient-to-br ${item.color} text-white shadow-md`}
      >
        <Icon className={compact ? "h-5 w-5" : "h-7 w-7"} />
      </div>
      <p
        className={`mt-2 font-black leading-tight text-slate-900 ${compact ? "text-xs" : "text-sm"}`}
      >
        {item.title}
      </p>
      {!compact ? (
        <p className="mt-1 text-xs font-bold text-slate-400">{item.subtitle}</p>
      ) : null}
    </button>
  );
}
    ...
    <div className="mt-3 flex flex-col gap-3 rounded-xl border border-blue-200 bg-blue-50 p-3 text-left md:flex-row md:items-start">
      ...
      <div className="flex flex-1 flex-wrap gap-2">
        {item.details.map((detail) => (
          <div
            key={detail}
            className="inline-flex min-h-9 items-center gap-2 rounded-lg bg-white px-3 py-2 text-sm font-bold leading-5 text-slate-700 shadow-sm ring-1 ring-blue-100"
          >
...
function FlowNode({
  ...
  return (
    ...
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-800 text-sm font-black text-white">
        {index + 1}
      </span>
...
export default function InfographicPage() {
  ...
  const selectedPrinciple = principleItems.find(
          ...
          <header className="relative border-b border-blue-100 bg-gradient-to-br from-white via-blue-50 to-cyan-50 px-5 py-6 md:px-8">
            <div className="absolute right-6 top-5 hidden rounded-2xl bg-white p-4 shadow-md ring-1 ring-blue-100 md:flex">
              <div className="flex items-center gap-3">
                ...
                <div className="rounded-lg bg-teal-600 px-4 py-2 text-xl font-black text-white">
                  API
                </div>
              </div>
            </div>
            <a
              href="/"
              className="mb-4 inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-blue-800 shadow-sm ring-1 ring-blue-100 hover:bg-blue-50"
            >
            ...
            <p className="mt-3 max-w-4xl text-base font-bold text-slate-600 md:text-lg">
              คลิกแต่ละจุดในภาพเพื่อดู field, logic, status และ error handling
              โดยไม่ต้องอ่านทั้งเอกสารยาว ๆ
            </p>
          </header>
          ...
          <div className="space-y-5 p-4 md:p-6">
            ...
            <div className="grid gap-5 lg:grid-cols-[0.95fr_1.45fr]">
              <section className="rounded-2xl border border-blue-200 bg-white p-4">
                  ...
                  {principleItems.map((item, index) => {
                    ...
                    return (
                      <div key={item.id}>
                        ...
                        >
                          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-teal-600 text-lg font-black text-white">
                            {index + 1}
                          </span>
                ...
                {selectedPrinciple ? (
                  <InlineDetails item={selectedPrinciple} />
                ) : null}
              </section>
              ...
              <section className="rounded-2xl border border-blue-200 bg-white p-4">
                ...
                <div className="mt-3 grid gap-2 md:grid-cols-3">
                  {[
                    "หลายรายการต้องแยกผล",
                    "ไม่ครบให้แก้ก่อนส่ง",
                    "แก้ไขแล้วต้องส่งอัปเดต",
                  ].map((note) => (
                    <div
                      key={note}
                      className="rounded-lg border border-dashed border-blue-300 bg-blue-50 px-3 py-2 text-center text-xs font-black text-blue-800"
                    >
                      {note}
                    </div>
                  ))}
            ...
            <div className="grid gap-5 lg:grid-cols-[0.95fr_1.45fr]">
              <section className="rounded-2xl border border-blue-200 bg-white p-4">
                  ...
                  {statusItems.map((item) => {
                    ...
                    return (
                      <div key={item.id}>
                        ...
                        >
                          <div
                            className={`flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br ${item.color} text-white`}
                          >
                ...
                {selectedStatus ? (
                  <InlineDetails item={selectedStatus} />
                ) : null}
              </section>
              ...
              <section className="rounded-2xl border border-blue-200 bg-white p-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-500">
                      ใช้ดู payload, response และ error ย้อนหลัง
                    </p>
                  </div>
                </button>
                {selectedId === logItem.id ? (
                  <InlineDetails item={logItem} />
                ) : null}
            ...
            <div className="grid gap-5 lg:grid-cols-[1fr_1fr]">
              ...
              <section className="rounded-2xl border border-blue-200 bg-white p-4">
                ...
                >
                  <div className="grid grid-cols-5 gap-2">
                    {retrySteps.map((step, index) => {
                      ...
                      return (
                        <div
                          key={step.label}
                          className="rounded-lg bg-white p-2 text-center ring-1 ring-slate-200"
                        >
                          <div
                            className={`mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-lg ${step.color} text-white`}
                          >
                  ...
                  <p className="text-left text-sm font-bold text-slate-600">
                    ส่งซ้ำเฉพาะรายการที่ไม่สำเร็จหรือถูกแก้ไขหลังส่งล่าสุด
                  </p>
                </button>
                {selectedId === retryItem.id ? (
                  <InlineDetails item={retryItem} />
                ) : null}
              </section>
            </div>
            ...
            <section className="rounded-2xl border border-blue-200 bg-white p-4">
                  ...
                  return (
                    ...
                    >
                      <div className="mb-3 flex items-center justify-between">
                        ...
                        <span
                          className={`rounded-full bg-gradient-to-r ${item.color} px-3 py-1 text-xs font-black text-white`}
                        >
                          {item.subtitle}
                        </span>
                      </div>
              ...
              {selectedResponse ? (
                <InlineDetails item={selectedResponse} />
              ) : null}
            </section>
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center">
                ...
                <div>
                  <p className="text-xl font-black">
                    เป้าหมาย: ตรวจสอบย้อนหลังได้ ลดข้อมูลตกหล่น
                    และรู้ว่าต้องส่งซ้ำรายการใด
                  </p>
                  <p className="mt-1 text-sm font-bold text-blue-100">
                    ใช้แผ่นนี้เป็นหน้าทำความเข้าใจ workflow
                    ก่อนลงรายละเอียดในระบบจริง
                  </p>
                </div>
              </div>
            </footer>
